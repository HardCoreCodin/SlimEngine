...
* Viewport: HUD (Head-UP Display)<br>
  <img src="src/examples/1_viewport.gif" alt="1_scene" height="360">
...
* Viewport: Navigation<br>
  <img src="src/examples/2_navigation.gif" alt="1_scene" height="360">
...
* Scene: Setup and drawing parametric primitives (Grid, Box, Curves, etc.)<br>
  <img src="src/examples/3_scene.gif" alt="1_scene" height="360">
  ...
  <p float="left">
    <img src="src/examples/3_scene_initialization_c.png" alt="3_scene_initialization_and_viewport_drawing_code" width="350">
...
* Scene: Object selection and manipulation (Translation, Rotation and Scale)<br>
  <p float="left">
    <img src="src/examples/4_manipulation_along_screen.gif" alt="4_manipulation_along_screen" height="360">
    <img src="src/examples/4_manipulation_along_axis_shapes.gif" alt="4_manipulation_along_axis_shapes" height="360">
  </p>
